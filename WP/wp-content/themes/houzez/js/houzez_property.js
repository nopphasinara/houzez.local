...
jQuery(document).ready( function($) {
    ...
    if ( typeof houzezProperty !== "undefined" ) {
        ...
        $('select[name="country_short"]').on('change', function() {
            ...
            var clearVal = $('select[name="administrative_area_level_1"], select[name="locality"], select[name="neighborhood"], select[name="neighborhood2"]');
        ...
        $('select[name="administrative_area_level_1"]').on('change', function() {
            ...
            var clearVal = $('select[name="locality"], select[name="neighborhood"], select[name="neighborhood2"]');
