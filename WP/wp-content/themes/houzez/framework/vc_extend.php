...
if (is_plugin_active('js_composer/js_composer.php')) {
	...
	if ( !function_exists('houzez_get_taxonomy_list') )
	{
	    ...
	    $houzez_add_shortcode_to_param = 'vc_add_';
	    $houzez_add_shortcode_to_param = $houzez_add_shortcode_to_param . 'shortcode_param';
	    $houzez_add_shortcode_to_param('houzez_get_taxonomy_list', 'houzez_get_vc_taxonomy_list');
	}
