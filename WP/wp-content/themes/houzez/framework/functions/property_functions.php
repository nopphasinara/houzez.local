...
if( !function_exists('houzez_property_search_2') ) {
    function houzez_property_search_2($search_query)
    {
        ...
        if($show_featured_on_top != 0 ) {
            $search_query['orderby'] = 'meta_value';
...
if( !function_exists('houzez_half_map_listings') ) {
    function houzez_half_map_listings() {
        ...
        $dummy_array = array();
        $custom_fields_values = $_POST['custom_fields_values'];
...
if( !function_exists('houzez_create_print')) {
    function houzez_create_print () {
        ...
        $property_status = houzez_taxonomy_simple_2('property_status', $property_id);
        $property_type = houzez_taxonomy_simple_2('property_type', $property_id);
