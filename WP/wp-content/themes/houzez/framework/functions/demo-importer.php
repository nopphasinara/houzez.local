    ...
    function houzez_menu_revolutionslider_homepage_setup( $demo_active_import , $demo_directory_path ) {
        ...
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                ...
                'houzez11' => 'homepage.zip',
                'houzez12' => 'homepage_slider.zip',
                'houzez13' => 'homepage.zip',
                'houzez14' => 'homepage_slider.zip',
            );
         ...
         * Setting Menus
         *************************************************************************/
        $wbc_menu_array = array( 'houzez01', 'houzez02', 'houzez03', 'houzez04', 'houzez05', 'houzez06', 'houzez07', 'houzez08', 'houzez09', 'houzez10', 'houzez11', 'houzez12', 'houzez13', 'houzez14' );
