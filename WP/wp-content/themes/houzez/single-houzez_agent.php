                        ...
                        <div class="profile-description">
                            ...
                            <ul class="profile-contact">
                                ...
                                <?php if( !empty($agent_office_num) ) { ?>
                                    <li><span><?php echo $houzez_local['office']; ?></span> <a href="tel:<?php echo esc_attr( $agent_office_call ); ?>"><span class="clickToShowPhone"><?php echo esc_attr( $agent_office_num ); ?></span></a></li>
                                <?php } ?>

                                <?php if( !empty( $agent_mobile ) ) { ?>
                                    <li><span><?php echo $houzez_local['mobile']; ?></span> <a href="tel:<?php echo esc_attr( $agent_mobile_call ); ?>"><span class="clickToShow"><?php echo esc_attr( $agent_mobile ); ?></span></a></li>
                                <?php } ?>
