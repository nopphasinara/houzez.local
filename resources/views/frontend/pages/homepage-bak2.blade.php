...
<head>
  ...
  <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('images/favicons/apple-touch-icon.png') }}" />
  ...
  <header id="header-section" class="header-section-4 header-main  nav-left hidden-sm hidden-xs" data-sticky="1">
    <div class="container">
      <div class="header-left">
        <div class="logo">
          <a href="{{ url('/') }}">
            <img src="{{ asset('images/luxury-properties-pattaya-logo.png') }}" alt="logo">
          </a>
        </div>
  ...
  <div class="header-mobile visible-sm visible-xs">
    <div class="container">
      ...
      <div class="header-logo">
        <a href="{{ url('/') }}"><img src="{{ asset('images/luxury-properties-pattaya-logo-white.png') }}" alt="logo"></a>
      </div>
